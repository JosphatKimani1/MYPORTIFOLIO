...
// ---------------------------------------
// Authenticated Routes (Admin / Profile)
// ---------------------------------------
...
// ---------------------------------------
// Catch-All 404 Fallback (Frontend Friendly)
// ---------------------------------------
Route::get('{any}', function () {
    return view('frontend.errorpage'); // Make sure this view exists
})->where('any', '.*');